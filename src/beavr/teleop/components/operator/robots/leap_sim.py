...
class LeapHandSimOperator(Operator):
    def __init__(
        self,
        host,
        ...
        self.notify_component_start("Leap hand sim operator")
        ...
        self.joint_angle_publisher = ZMQPublisherManager(host=host, port=jointanglepublishport)

        self.joint_angle_subscriber = ZMQSubscriber(
    ...
    def _apply_retargeted_angles(self):
        ...
        self.joint_angle_publisher.publish(desired_joint_angles, "desired_angles")
